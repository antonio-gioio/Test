        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SpeedOverGround = table.Column<double>(type: "double precision", nullable: true),
                    CourseOverGround = table.Column<double>(type: "double precision", nullable: true),
                    TrueHeading = table.Column<double>(type: "double precision", nullable: true),
                    NavigationalStatus = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Vessels", x => x.Mmsi);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FollowedVessels", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FollowedVessels_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FollowedVessels_UserId_Mmsi",
                table: "FollowedVessels",
                columns: new[] { "UserId", "Mmsi" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TrackPoints_Mmsi_Timestamp",
                table: "TrackPoints",
                columns: new[] { "Mmsi", "Timestamp" });

            migrationBuilder.CreateIndex(
                name: "IX_Vessels_LastUpdate",
                table: "Vessels",
                column: "LastUpdate");

            migrationBuilder.CreateIndex(
                name: "IX_Vessels_Location",
                table: "Vessels",
                column: "Location")
